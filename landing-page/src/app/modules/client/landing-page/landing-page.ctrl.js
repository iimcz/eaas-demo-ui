    ...
    var confirmStartFn = function(inputs)
    {
        ...
        vm.openNetworkDialog = function() {
            $uibModal.open({
                ...
                controller:['$scope' , 'growl', 'REST_URLS', function ($scope, growl, REST_URLS) {
                    this.network = vm.network;
                    this.env = vm.env;
                    var modalCtrl = this;
                    ...
                    let helptext  = replaceMulti(replaceMulti(vm.env.helpText, '$$host$$', vm.hostname), '$$port$$', vm.port);
                    this.port = vm.port;
                    this.localServerMode = vm.env.localServerMode;
                    console.log(this.localServerMode);
                    this.hostname = vm.hostname;
                        ...
                        $http.post(localConfig.data.eaasBackendURL + REST_URLS.detachSessionUrl, {
                            ...
                            resources: [
                                ...
                                },
                                {
                                    ...
                                    type: "network",
                                    keepalive_url: localConfig.data.eaasBackendURL + "networks/" + eaasClient.networkId + "/keepalive"
                                }
                            ]
