...
EaasClient.Client=function(b,f){function g(a){var m=Array.prototype.slice.call(arguments,1);return a.replace(/{(\d+)}/g,function(p,a){return"undefined"!=typeof m[a]?m[a]:p})}function h(a){var m={};if(!a)return m;a.split("\x26").forEach(function(a){a=a.split("\x3d");m[a[0]]=decodeURIComponent(a[1])})}function l(a){var m=document.getElementsByTagName("script"),b;for(b in m){var c="eaas-client.js";if("undefined"!=typeof m[b].src&&-1!=m[b].src.indexOf(c))var y=m[b].src}var k=y.substring(0,y.indexOf(c))+
...
$.getScript(k+"/js/Protocol.js"),$.getScript(k+"/js/Client.js"),$.Deferred(function(a){$(a.resolve)})).done(function(){J(a,k)})}xpraShapes={xpraWidth:1024,xpraHeight:768,xpraDPI:96};this.setXpraShapes=function(a,m,b){xpraShapes={xpraWidth:a,xpraHeight:m,xpraDPI:b}};var c=this,d=b.replace(/([^:])(\/\/+)/g,"$1/").replace(/\/+$/,"");this.params=this.driveId=this.networkId=this.componentId=null;var q=!1;this.pollState=function(a){$.get(d+g("/components/{0}/state",c.componentId)).then(function(a,b,x){q?
(a=a.state,"OK"==a?c.keepalive():"INACTIVE"==a?location.reload():c._onError("Invalid component state: "+a)):$.get(d+g("/components/{0}/controlurls",c.componentId)).then(function(a,b,m){"undefined"!==typeof a.xpra?(c.params=h(a.xpra.substring(a.xpra.indexOf("#")+1)),l(a.xpra)):(c.params=h(a.guacamole.substring(a.guacamole.indexOf("#")+1)),c.establishGuacamoleTunnel(a.guacamole));c.pollStateInterval=setInterval(c.pollState,1500);q=!0;for(a=0;a<n.length;a++)if(n[a])n[a]()})},function(a){c._onError($.parseJSON(a.responseText))})};
var n=[];this.addOnConnectListener=function(a){console.log("hasConnected, after"+q);if(q)return a(),{remove:function(){}};var b=n.push(a)-1;return{remove:function(){delete n[b]}}};this._onError=function(a){this.keepaliveIntervalId&&clearInterval(this.keepaliveIntervalId);this.guac&&this.guac.disconnect();if(this.onError)this.onError(a||{error:"No error message specified"})};this._onResize=function(a,b){f.style.width=a;f.style.height=b;if(this.onResize)this.onResize(a,b)};this.keepalive=function(){var a=
...
$(a).attr("tabindex","0");$(a).css("outline","0");$(a).mouseenter(function(){$(this).focusWithoutScrolling()});if(this.onReady)this.onReady()};this.startEnvironment=function(a,b){var p={type:"machine"};p.environment=a;"undefined"!==typeof b&&(p.keyboardLayout=b.keyboardLayout,p.keyboardModel=b.keyboardModel,p.object=b.object,null==b.object&&(p.software=b.software));$.ajax({type:"POST",url:d+"/components",data:JSON.stringify(p),contentType:"application/json"}).then(function(a,b,d){c.componentId=a.id;
c.driveId=a.driveId;c.pollState()},function(a){c._onError($.parseJSON(a.responseText))})};this.getScreenshotUrl=function(){return d+g("/components/{0}/screenshot",c.componentId)};this.getPrintUrl=function(){return d+g("/components/{0}/print",c.componentId)};this.stopEnvironment=function(){this.guac.disconnect();$.ajax({type:"GET",url:d+g("/components/{0}/stop",c.componentId),async:!1});$(f).empty()};this.clearTimer=function(){clearInterval(this.keepaliveIntervalId)};this.release=function(){this.stopEnvironment();
this.clearTimer()};this.sendCtrlAltDel=function(){this.guac.sendKeyEvent(1,65513);this.guac.sendKeyEvent(1,65507);this.guac.sendKeyEvent(1,65535);this.guac.sendKeyEvent(0,65513);this.guac.sendKeyEvent(0,65507);this.guac.sendKeyEvent(0,65535)};this.changeMedia=function(a,b){$.ajax({type:"POST",url:d+g("/components/{0}/changeMedia",c.componentId),data:JSON.stringify(a),contentType:"application/json"}).then(function(a,c,d){b(a,c)})};var J=function(a,b){function c(a){return window.location.getParameter(a)}
function d(a,b){a=window.location.getParameter(a);return null==a?b:0<=["true","on","1"].indexOf(String(a).toLowerCase())}window.location.getParameter||(window.location.getParameter=function(a){if(!this.queryStringParams){for(var b={},c,d=/\+/g,g=/([^&=]+)=?([^&]*)/g,f=window.location.search.substring(1);c=g.exec(f);)b[decodeURIComponent(c[1].replace(d," "))]=decodeURIComponent(c[2].replace(d," "));this.queryStringParams=b}return this.queryStringParams[a]});window.oncontextmenu=function(a){return!1};
$(document).ready(function(){var g=c("username")||null,k=c("password")||null,f=c("sound")||"true",h=c("audio_codec")||"opus+mka",l=c("encoding")||null,m=c("action")||"connect",p=c("submit")||null,n=a.substring(7,a.indexOf("8080")-1),x=a.substring(a.indexOf("8080")),q=c("encryption")||null,z=c("key")||null,t=c("keyboard_layout")||null,r=c("start"),A=c("exit_with_children")||"",B=c("exit_with_client")||"",C=d("sharing",!1),D=d("video",!1),E=d("mediasource_video",!1),F=d("normal_fullscreen",!1),G=d("remote_logging",
!0),u=d("debug",!1),H=d("insecure",!1),I=d("ignore_audio_blacklist",!1),v=d("clipboard",!0),e=new XpraClient("emulator-container");e.debug=u;e.remote_logging=G;e.sharing=C;e.insecure=H;e.clipboard_enabled=v;D?(e.supported_encodings.push("h264"),E&&e.supported_encodings.push("vp8+webm","h264+mp4","mpeg4+mp4")):l&&"auto"!==l&&e.enable_encoding(l);m&&"connect"!=m&&(sns={mode:m},r&&(sns.start=[r]),A&&(sns["exit-with-children"]=!0),B&&(sns["exit-with-client"]=!0),e.start_new_session=sns);F&&(e.normal_fullscreen_mode=
!0);f&&(e.audio_enabled=!0,console.log("sound enabled, audio codec string: "+h),h&&0<h.indexOf(":")&&(r=h.split(":"),e.audio_framework=r[0],e.audio_codec=r[1]),e.audio_mediasource_enabled=d("mediasource",!0),e.audio_aurora_enabled=d("aurora",!0));t&&(e.keyboard_layout=t);g&&(e.username=g);k&&(e.authentication_key=k);q&&(e.encryption=q,z&&(e.encryption_key=z));u||(e.callback_close=function(a){if(p){var b="Connection closed (socket closed)";a&&(b=a);a="/connect.html?disconnect\x3d"+encodeURIComponent(b);
var b={username:g,password:k,encoding:l,keyboard_layout:t,action:m,sound:f,audio_codec:h,clipboard:v,exit_with_children:A,exit_with_client:B,sharing:C,normal_fullscreen:F,video:D,mediasource_video:E,debug:u,remote_logging:G,insecure:H,ignore_audio_blacklist:I},c;for(c in b){var d=b[c];d&&(a+="\x26"+c+"\x3d"+encodeURIComponent(d))}window.location=a}else window.location="connect.html"});e.init(I);q="https:"==document.location.protocol;XpraClient.prototype._do_connect=function(a){this.protocol=a&&!XPRA_CLIENT_FORCE_NO_WORKER?
new XpraProtocolWorkerHost:new XpraProtocol;this.protocol.set_packet_handler(this._route_packet,this);a="ws://";this.ssl&&(a="wss://");a+=this.host;a+=":"+this.port;this.protocol.open=function(a){var c=this;this.worker=new Worker(b+"/js/Protocol.js");this.worker.addEventListener("message",function(b){var d=b.data;switch(d.c){case "r":c.worker.postMessage({c:"o",u:a});break;case "p":c.packet_handler&&c.packet_handler(d.p,c.packet_ctx);break;case "l":console.log(d.t);break;default:console.error("got unknown command from worker"),
console.error(b.data)}},!1)};this.protocol.open(a);var c=this;this.hello_timer=setTimeout(function(){c.disconnect_reason="Did not receive hello before timeout reached, not an Xpra server?";c.close()},this.HELLO_TIMEOUT)};XpraClient.prototype._get_desktop_size=function(){return[xpraShapes.xpraWidth,xpraShapes.xpraHeight]};XpraClient.prototype._get_DPI=function(){return xpraShapes.xpraDPI};e.connect=XpraClient.prototype.connect=function(a,c,d){console.log("connecting to xpra server "+a+":"+c+" with ssl: "+
...
e._do_connect(!1)}},!1);a.postMessage({cmd:"check"})}else console.log("no webworker support at all.");else this.callback_close("no key specified for encryption")};e._new_window=function(a,b,c,d,e,g,f,h){var w=document.createElement("div");w.id=String(a);var k=document.createElement("canvas");w.appendChild(k);document.getElementById("emulator-container").appendChild(w);k.width=d;k.height=e;b=new XpraWindow(this,k,a,b,c,d,e,g,f,h,this._window_geometry_changed,this._window_mouse_move,this._window_mouse_click,
this._window_set_focus,this._window_closed);b.debug=this.debug;this.id_to_window[a]=b;f||(this.normal_fullscreen_mode&&"NORMAL"==b.windowtype&&(b.undecorate(),b.set_maximized(!0)),f=b.get_internal_geometry(),this.protocol.send(["map-window",a,f.x,f.y,f.w,f.h,this._get_client_properties(b)]),this._window_set_focus(b));b.undecorate();b.ensure_visible();b.fill_screen();b.set_maximized(!0)};XpraWindow.prototype.getMouse=function(a){var b=a.clientX+jQuery(document).scrollLeft(),c=a.clientY+jQuery(document).scrollTop();
isNaN(b)||isNaN(c)?isNaN(this.last_mouse_x)||isNaN(this.last_mouse_y)?c=b=0:(b=this.last_mouse_x,c=this.last_mouse_y):(this.last_mouse_x=b,this.last_mouse_y=c);var d=0;"which"in a?d=Math.max(0,a.which):"button"in a&&(d=Math.max(0,a.button)+1);a=$("#emulator-container").offset();b-=a.left;c-=a.top;return{x:b,y:c,button:d}};e.connect(n,x,q);v&&(n=$("#pasteboard"),n.on("paste",function(a){a=(a.originalEvent||a).clipboardData.getData("text/plain");e.send_clipboard_token(unescape(encodeURIComponent(a)));
return!1}),n.on("copy",function(a){a=e.get_clipboard_buffer();$("#pasteboard").text(decodeURIComponent(escape(a)));$("#pasteboard").select();e.clipboard_pending=!1;return!0}),n.on("cut",function(a){a=e.get_clipboard_buffer();$("#pasteboard").text(decodeURIComponent(escape(a)));$("#pasteboard").select();e.clipboard_pending=!1;return!0}),$("#emulator-container").on("click",function(a){e.clipboard_pending&&(e.get_clipboard_buffer(),$("#pasteboard").text(e.clipboard_buffer),$("#pasteboard").select(),
a=!0,window.clipboardData&&window.clipboardData.setData?clipboardData.setData("Text",this.clipboard_buffer):a=document.execCommand("copy"),a&&(e.clipboard_pending=!1))}))})};this.startEnvironmentWithInternet=function(a,b,c){$.ajax({type:"POST",url:d+"/components",data:JSON.stringify({environment:a,keyboardLayout:b,keyboardModel:c}),contentType:"application/json"}).done(function(a){this.tmpdata=a;$.ajax({type:"POST",url:d+"/networks",data:JSON.stringify({components:[{componentId:a.id}],hasInternet:!0}),
contentType:"application/json"}).done(function(a){this.pollState(this.tmpdata.controlUrl.replace(/([^:])(\/\/+)/g,"$1/"),this.tmpdata.id)}.bind(this)).fail(function(a,b,c){this._onError($.parseJSON(a.responseText))}.bind(this))}.bind(this)).fail(function(a,b,c){}.bind(this))}};var BWFLA=BWFLA||{};
