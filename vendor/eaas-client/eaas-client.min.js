...
EaasClient.Client=function(b,f){function g(a){var m=Array.prototype.slice.call(arguments,1);return a.replace(/{(\d+)}/g,function(n,a){return"undefined"!=typeof m[a]?m[a]:n})}function h(a){var m={};if(!a)return m;a.split("\x26").forEach(function(a){a=a.split("\x3d");m[a[0]]=decodeURIComponent(a[1])});return m}function l(a){var m=document.getElementsByTagName("script"),b;for(b in m){var c="eaas-client.js";if("undefined"!=typeof m[b].src&&-1!=m[b].src.indexOf(c))var v=m[b].src}var k=v.substring(0,v.indexOf(c))+
