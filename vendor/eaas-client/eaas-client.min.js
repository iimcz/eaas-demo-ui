...
var b=this,h=c.replace(/([^:])(\/\/+)/g,"$1/").replace(/\/+$/,"");this.pollStateIntervalId=this.params=this.driveId=this.networkId=this.componentId=null;var f;this.pollState=function(){$.get(h+e("/components/{0}/state",b.componentId)).then(function(d,a,m){f=d.state;"OK"==f?b.keepalive():"STOPPED"==f||"FAILED"==f?(b.keepalive(),$("#emulator-container").text("EMULATOR HAS STOPPED!")):"INACTIVE"==f?location.reload():b._onFatalError("Invalid component state: "+this.emulatorState)}).fail(function(){b._onFatalError("connection failed")})};
...
this.release=function(){for(var d=this.disconnect();"pending"===d.state(););this.stopEnvironment();this.clearTimer()};this.sendCtrlAltDel=function(){this.guac.sendKeyEvent(1,65513);this.guac.sendKeyEvent(1,65507);this.guac.sendKeyEvent(1,65535);this.guac.sendKeyEvent(0,65513);this.guac.sendKeyEvent(0,65507);this.guac.sendKeyEvent(0,65535)};this.snapshot=function(d,a){$.ajax({type:"POST",url:h+e("/components/{0}/snapshot",b.componentId),data:JSON.stringify(d),contentType:"application/json"}).then(function(d,
b,c){a(d,b)})};this.changeMedia=function(d,a){$.ajax({type:"POST",url:h+e("/components/{0}/changeMedia",b.componentId),data:JSON.stringify(d),contentType:"application/json"}).then(function(d,b,c){a(d,b)})};this.prepareAndLoadXpra=function(d){var a=document.getElementsByTagName("script"),c;for(c in a){var f="eaas-client.js";if("undefined"!=typeof a[c].src&&-1!=a[c].src.indexOf(f))var e=a[c].src}var l=e.substring(0,e.indexOf(f))+"xpra/";$.when($.getScript(l+"/eaas-xpra.js"),$.getScript(l+"/js/lib/jquery-ui.js"),
$.getScript(l+"/js/lib/jquery.ba-throttle-debounce.js"),$.getScript(l+"/js/lib/bencode.js"),$.getScript(l+"/js/lib/zlib.js"),$.getScript(l+"/js/lib/lz4.js"),$.getScript(l+"/js/lib/forge.js"),$.getScript(l+"/js/lib/broadway/Decoder.js"),$.getScript(l+"/js/lib/aurora/aurora-xpra.js"),$.getScript(l+"/js/Utilities.js"),$.getScript(l+"/js/Keycodes.js"),$.getScript(l+"/js/Notifications.js"),$.getScript(l+"/js/MediaSourceUtil.js"),$.getScript(l+"/js/Window.js"),$.getScript(l+"/js/Protocol.js"),$.getScript(l+
"/js/Client.js"),$.getScript(l+"/js/Client.js"),$.Deferred(function(a){$(a.resolve)})).done(function(){loadXpra(d,l,b.xpraShapes)})};this.prepareAndLoadWebEmulator=function(d){var a=document.getElementsByTagName("script"),b;for(b in a){var c="eaas-client.js";if("undefined"!=typeof a[b].src&&-1!=a[b].src.indexOf(c))var f=a[b].src}a=f.substring(0,f.indexOf(c))+"webemulator/";b=document.createElement("iframe");b.setAttribute("style","width: 100%; height: 600px;");b.src=a+"#controlurls\x3d"+d;g.appendChild(b)};
this.startEnvironmentWithInternet=function(d,a){var c={type:"machine"};c.environment=d;"undefined"!==typeof a&&(c.keyboardLayout=a.keyboardLayout,c.keyboardModel=a.keyboardModel,c.object=a.object,null==a.object&&(c.software=a.software),c.userContext=a.userContext);var f=$.Deferred();console.log("Starting environment "+d+"...");$.ajax({type:"POST",url:h+"/components",data:JSON.stringify(c),contentType:"application/json"}).then(function(a,c,e){console.log("Environment "+d+" started.");$.ajax({type:"POST",
url:h+"/networks",data:JSON.stringify({components:[{componentId:a.id}],hasInternet:!0}),contentType:"application/json"}).then(function(d,c,e){b.componentId=a.id;b.driveId=a.driveId;b.networkId=d.id;b.isStarted=!0;b.pollStateIntervalId=setInterval(b.pollState,1500);f.resolve()})},function(a){b._onFatalError($.parseJSON(xhr.responseText));f.reject()});return f.promise()};this.startConnectedEnvironments=function(d,a,c){var f={type:"machine"};f.environment=d;"undefined"!==typeof c&&(f.keyboardLayout=
c.keyboardLayout,f.keyboardModel=c.keyboardModel,f.object=c.object,null==c.object&&(f.software=c.software),f.userContext=c.userContext);var e=$.Deferred();console.log("Starting environment "+d+"...");$.ajax({type:"POST",url:h+"/components",data:JSON.stringify(f),contentType:"application/json"}).then(function(c,g,k){console.log("Environment "+d+" started.");f.environment=a;$.ajax({type:"POST",url:h+"/components",data:JSON.stringify(f),contentType:"application/json"}).then(function(a,d,f){$.ajax({type:"POST",
