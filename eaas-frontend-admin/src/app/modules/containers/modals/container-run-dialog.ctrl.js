module.exports = ['$state', '$http', '$scope', '$uibModal', '$uibModalInstance', 'Upload', 'currentEnv', 'localConfig', 'growl', '$timeout', '$uibModalStack', 'REST_URLS', 'helperFunctions',
    function ($state, $http, $scope, $uibModal, $uibModalInstance, Upload, currentEnv, localConfig, growl, $timeout, $uibModalStack, REST_URLS, helperFunctions) {
        this.run = function () {
