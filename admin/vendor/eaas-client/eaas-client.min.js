...
EaasClient.Client=function(a,d){function c(a){var k=Array.prototype.slice.call(arguments,1);return a.replace(/{(\d+)}/g,function(a,b){return"undefined"!=typeof k[b]?k[b]:a})}function f(a){var b={};if(!a)return b;a.split("\x26").forEach(function(a){a=a.split("\x3d");b[a[0]]=decodeURIComponent(a[1])});return b}var b=this,g=a.replace(/([^:])(\/\/+)/g,"$1/").replace(/\/+$/,"");this.params=this.driveId=this.networkId=this.componentId=null;var e=!1;this.pollState=function(a){$.get(g+c("/components/{0}/state",
b.componentId)).then(function(a,l,d){if(!b.guac)for($.get(g+c("/components/{0}/controlurls",b.componentId)).then(function(a,l,k){b.params=f(a.guacamole.substring(a.guacamole.indexOf("#")+1));b.establishGuacamoleTunnel(a.guacamole);b.keepaliveIntervalId=setInterval(b.keepalive,1E3)}),e=!0,a=0;a<h.length;a++)if(h[a])h[a]()},function(a){b._onError($.parseJSON(a.responseText))})};var h=[];this.addOnConnectListener=function(a){if(e)return a(),{remove:function(){}};var b=h.push(a)-1;return{remove:function(){delete h[b]}}};
